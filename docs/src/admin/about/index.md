...
The Administration section documents the internal features used to manage the platform. It includes data management, configuration, and operational workflows such as creating, updating, and deleting records, as well as other administrative tasks performed by authorized users.
